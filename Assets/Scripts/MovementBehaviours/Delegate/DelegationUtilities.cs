...
public abstract class MovementBehaviour : MonoBehaviour {
	public abstract Vector3 GetAcceleration (MovementStatus status, Vector3 destination);
}

//To be extended by the classes that choose the destination point 
[DisallowMultipleComponent]
public abstract class PathFollowing : MonoBehaviour
{
	public abstract Vector3 GetDestination(MovementStatus status);
}
